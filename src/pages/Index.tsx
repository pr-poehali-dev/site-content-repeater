            ...
            <div className="text-center py-6 space-y-4">
              ...
              <div className="max-w-2xl mx-auto bg-[#2a2a2a]/60 px-6 py-4 rounded-lg border border-white/10">
                ...
                <p className="text-white/60 text-xs leading-relaxed mt-3">
                  Проект является некоммерческим фанатским сервером с атмосферой, вдохновленной DayZ. 
                  Не копирует механики оригинальной игры, а воссоздает лишь атмосферу выживания в Minecraft. 
                  Не связан с правообладателями DayZ или Minecraft. Все права на торговые марки принадлежат их владельцам. 
                  Проект не преследует коммерческих целей и создан исключительно для развлечения игроков. 
                  Администрация не несет ответственности за возможные претензии третьих лиц.
                </p>
              </div>
            </div>
          </div>
